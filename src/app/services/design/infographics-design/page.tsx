...
import { BarChart3, FileText, Image, TrendingUp } from 'lucide-react';
...
export default function InfographicsDesignPage() {
  const services = [
    ...
    },
    {
      ...
      description: 'Engaging educational and instructional graphics'
    },
    {
      icon: <Image className="w-10 h-10" />,
      title: 'Social Media Infographics',
      description: 'Shareable infographics for social platforms'
    },
    {
      icon: <TrendingUp className="w-10 h-10" />,
      title: 'Business Infographics',
      description: 'Professional infographics for presentations'
    }
  ];
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl mx-auto text-center theme-card rounded-2xl p-8">
            ...
            <p className="theme-text-secondary mb-6">
              Let's visualize your data beautifully.
            </p>
            <Link
